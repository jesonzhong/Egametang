...
public class IPABuilder {
	...
	public static string appPath = Application.dataPath + "/../proj_ios/build/Release-iphoneos/tank.app ";

	public static string ipaPath =  Application.dataPath + "/../game.ipa";

	public static string CodeSing = "\"iPhone Distribution: Shanghai Giant Network Technology Co., Ltd.\"";

    public static string provision = Application.dataPath + "/../IOSLicense/mark/allToOne.mobileprovision";
