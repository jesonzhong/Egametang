namespace Model
{
	...
	public enum Opcode: ushort
	{
		...
		C2G_CreateMatchRoom = 1012,
        G2C_CreateMatchRoom = 1013,
		
		C2G_GetRoomList = 1014,
		G2C_GetRoomList = 1015,
    ...
    ActorRequest = 1,
        ...
        G2M_CreateMatchRoom = 107,
        M2G_CreateMatchRoom = 108,

        C2G_JoinMatchRoom = 109,
        G2C_JoinMatchRoom = 110,
