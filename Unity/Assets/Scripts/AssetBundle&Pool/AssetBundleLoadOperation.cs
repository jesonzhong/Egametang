...
public class AssetBundleLoadLevelOperation : AssetBundleLoadBaseOperation
{
	...
	public override bool Update ()
	{
        ...
        if(string.IsNullOrEmpty(m_AssetBundleName) || string.IsNullOrEmpty(m_LevelName))
        {
            Debug.LogError("AssetBundleLoadLevelOperation  m_AssetBundleName:" + m_AssetBundleName + "  m_LevelName:" + m_LevelName);
            return false;
        }
