...
public class Pool : MonoBehaviour
{
    ...
    public GameObject Spawn(Vector3 position, Quaternion rotation)
    {
        ...
        else
        {
            ...
            if (limit && (maxCount > 0 && active.Count >= maxCount))
                return null;
        ...
        PoolManager.AddInstancePoolMap(obj, this);
        //submit instance
        return obj;
    }
    ...
    public void Despawn(GameObject instance)
    {
        ...
        PoolManager.RemoveInstancePoolMap(instance);
        //Test
    ...
    void OnDestroy()
    {
        active.Clear();
        inactive.Clear();
        //Debug.Log("Pool OnDestroy:" + name + " " +Time.time);
    }
}
